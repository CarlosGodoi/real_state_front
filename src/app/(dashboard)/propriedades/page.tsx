...
export default function Property() {
    return (
        <main className="w-full min-h-full flex flex-col gap-3 bg-gray_08">
            <div className="relative w-full h-[400px] flex items-center bg-gradient-to-r from-gray_15 to-gray_08 px-16 mobile_1:h-full mobile_1:static mobile_1:py-4 mobile_1:px-6">
                <div className="w-[90%] flex flex-col gap-6 mobile_1:w-full">
                    <h2 className="text-5xl text-secondary font-semibold mobile_1:text-center">Encontre o imóvel dos seus sonhos</h2>
            ...
            <section className="w-full flex flex-col items-center mobile_1:px-6">
